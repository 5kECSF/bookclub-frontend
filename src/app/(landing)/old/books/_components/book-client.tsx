...
const BookClient = ({ searchParams }: { searchParams: Filter }) => {
  ...
  const items: MenuProps["items"] = [
    {
      key: "1",
      label: <li onClick={() => handleClick("A-Z")}>A-Z</li>,
    },
    {
      key: "2",
      label: <li onClick={() => handleClick("Z-A")}>Z-A</li>,
    },
  ];

  const [grid, setGrid] = useState(true);
  return (
    <div className="mx-auto mt-4 min-h-[60vh] max-w-[1400px] px-8 sm:px-4">
      <div className=" md:col-span-2 ">
        <div className="mb-8  mt-4 flex items-center justify-between lg:mt-0 ">
          {/*<FilterSide />*/}
          ...
          <div className="flex items-center gap-2 text-[30px]">
            <BsGrid3X2GapFill
              ...
              className={`${grid ? `text-red-600` : ``} cursor-pointer`}
            />
            <BiMenu
